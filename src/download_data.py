...
def download_dataset():
    ...
    try:
        ...
        subprocess.run(["kaggle", "datasets", "download", "-d", dataset_name, "-p", raw_dir], check=True)
        print("Download complete.")
        
        # Unzip
        zip_path = os.path.join(raw_dir, "dental-disease-panoramic-detection-dataset.zip")
